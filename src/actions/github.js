...
export const aboutPromise = () =>
    repo.getContents(GITHUB_REF, ABOUT_PATH);
export const postsPromise = () =>
    repo.getContents(GITHUB_REF, POSTS_PATH);
export const booksPromise = () =>
    repo.getContents(GITHUB_REF, BOOKS_PATH);
export const podcastsPromise = () =>
    repo.getContents(GITHUB_REF, PODCASTS_PATH);
